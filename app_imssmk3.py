...
if uploaded_file is not None:
    ...
    with tab2:
        ...
        fig_radar = go.Figure()
        fig_radar.add_trace(go.Scatterpolar(r=avg_scores, theta=categories, fill='toself', fillcolor='rgba(99, 110, 250, 0.5)', line=dict(color='#636EFA', width=3)))
        ...
        fig4 = px.scatter(df, x='Implementation Risk Maturity', y='Estimasi Kerugian Finansial Atas Temuan Audit', color='Departemen Divisi/Area', size='Implementation Risk Maturity', hover_data=['Detail Temuan Ketidaksesuaian'], template="plotly_white")
